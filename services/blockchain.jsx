...
import abi from '@/artifacts/contracts/DappAirBnb.sol/DappAirBnb.json'
...
const getEthereumContracts = async () => {
  ...
  if (accounts?.length > 0) {
    ...
    const contracts = new ethers.Contract(address.dappBnbContract, dappAirBnbAbi.abi, signer)
    ...
    const contracts = new ethers.Contract(address.dappAirBnbContract, abi.abi, signer)
